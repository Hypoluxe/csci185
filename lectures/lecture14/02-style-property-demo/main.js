...
function makeBlue() {
    ...
    document.querySelector('#section1').style.backgroundColor ='blue';
};

function makePink() {
    // your code here...
    console.log('Change background to pink');
    document.querySelector('#section2').style.backgroundColor ='pink';
};

function makeOrange() {
    // your code here...
    console.log('Change background to orange');
    document.querySelector('#section3').style.backgroundColor ='orange';
};
